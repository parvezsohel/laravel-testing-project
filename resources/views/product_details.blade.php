	...
	<div class="page-area product-page spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<figure>
						<img class="product-big-img" src="{{ asset('uploads/product_img') }}/{{ $single_product_info->product_image }}" alt="">
					</figure>
					<div class="product-thumbs">
						<div class="product-thumbs-track">
							<div class="pt" data-imgbigurl="{{ asset('uploads/product_img') }}/{{ $single_product_info->product_image }}"><img src="{{ asset('uploads/product_img') }}/{{ $single_product_info->product_image }}" alt=""></div>
							<div class="pt" data-imgbigurl="{{ asset('uploads/product_img') }}/{{ $single_product_info->product_image }}"><img src="{{ asset('uploads/product_img') }}/{{ $single_product_info->product_image }}" alt=""></div>
							<div class="pt" data-imgbigurl="{{ asset('uploads/product_img') }}/{{ $single_product_info->product_image }}"><img src="{{ asset('uploads/product_img') }}/{{ $single_product_info->product_image }}" alt=""></div>
							<div class="pt" data-imgbigurl="{{ asset('uploads/product_img') }}/{{ $single_product_info->product_image }}"><img src="{{ asset('uploads/product_img') }}/{{ $single_product_info->product_image }}" alt=""></div>
						</div>
        ...
        @foreach ($related_products as $related_product)
          <div class="col-lg-3">
            <div class="product-item">
              <a href="{{ url('product/details') }}/{{ $related_product->id }}" style="cursor:pointer">
                <figure>
                    <img src="{{ asset('uploads/product_img') }}/{{ $related_product->product_image }}" alt="" style="cursor:pointer">
